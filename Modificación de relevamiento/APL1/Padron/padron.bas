...
On Error Resume Next
    ...
    ActiveSheet.Unprotect Password:="crowe"
...
ElseIf (parte = "IGR" Or parte = "LBL") Then
    ...
    For i = 1 To 310
        ...
        ThisWorkbook.Sheets("Requerimientos").Cells(i, 1).Value = "Embarazos")) Then
                ...
                If (codigo = "CTC001A97" And ActiveSheet.Cells(filaDobleClick, columnaDobleClick + 32).Value = "Niños") Then
                    ...
                    If ((ActiveSheet.Cells(filaDobleClick, columnaDobleClick + 20).Value < 1 And ThisWorkbook.Sheets("Requerimientos").Cells(i, 3).Value = "menores de 1") Or _
                    ((ActiveSheet.Cells(filaDobleClick, columnaDobleClick + 20).Value >= 1 And ActiveSheet.Cells(filaDobleClick, columnaDobleClick + 20).Value < 6) And ThisWorkbook.Sheets("Requerimientos").Cells(i, 3).Value = "1 a 5") Or _
                    (ActiveSheet.Cells(filaDobleClick, columnaDobleClick + 20).Value >= 6 And ThisWorkbook.Sheets("Requerimientos").Cells(i, 3).Value = "mayores a 6")) Then
...
'                                    End With
                                ...
                                Or texto = "Odontograma" Or texto = "Medicion de agudeza visual") Then
