VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} userForm_eyp 
   Caption         =   "Formulario de relevamiento - Embarazos y partos"
   ClientHeight    =   8700
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   15510
   OleObjectBlob   =   "userForm_eyp.frx":0000
   StartUpPosition =   1  'Centrar en propietario
End
Attribute VB_Name = "userForm_eyp"
...
If (userForm_eyp_verificacion_blancos = 1) Then
...
If (auxiliarInexistenteEYP = 1) Then
...
auxiliarInexistenteEYP = 0

End If


Call userForm_eyp_guardar_datos(filaDobleClickEYP)

MsgBox ("Se han guardado con exito")


If (userForm_eyp.dato_validacion.Text = "Labrar acta" Or userForm_eyp.dato_validacion.Text = "Labrar acta e indicar fuente de información en observaciones") Then

    Cells(filaDobleClickEYP, columnaDobleClickEYP).Value = "Labrar acta"

ElseIf (userForm_eyp_verificacion_blancos <> 1) Then

    Cells(filaDobleClickEYP, columnaDobleClickEYP).Value = "Completo"

Else

    Cells(filaDobleClickEYP, columnaDobleClickEYP).Value = "Incompleto"
...
'con este if se evita que se ingresen datos que no estan permitidos
If (dato_fecha_notificacion.Text <> "Dato no obligatorio" And dato_fecha_notificacion.Text <> "Si" And dato_ta.Text <> "si" And dato_fecha_notificacion.Text <> "No" _
...
'para que siga escribiendo en una linea de inferior
userForm_eyp.dato_observaciones.MultiLine = True
...
Or dato_fuente.Text = "Prestación inexistente" Or dato_fuente.Text = "Caso duplicado") Then
    ...
    If dato_fuente.Text <> "No consta fuente de información" And dato_fuente.Text <> "Prestación inexistente" And dato_fuente.Text <> "Caso duplicado" Then
        ...
        If (codigoDobleClickEYP <> "") Then
            ...
            Call userForm_eyp_permitir_campos_requeridos(codigoDobleClickEYP)
        ...
        On Error Resume Next
            ...
            concatenacion = TextBox_codigo.Text & dato_fuente.Text & ActiveSheet.Cells(filaDobleClickEYP, columnaDobleClickEYP + 23).Value
...
'constancia de solicitud de screening neonatal
With dato_screening_neonatal
.AddItem "Si"
.AddItem "No"
End With
...
'fecha de notificacion, embarazo y parto
...
If (Cells(filaDobleClickEYP, columnaDobleClickEYP + 1) = "") Then
dato_validacion.Text = "Ingresar la fuente de información"
dato_validacion.BackColor = RGB(255, 255, 0)
End If
