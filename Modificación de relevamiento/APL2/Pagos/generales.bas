...
ThisWorkbook.Sheets("Niños y Adolescentes").Range("N:N,Q:AE,AG:AG,AI:AR").EntireColumn.Hidden = True
...
ThisWorkbook.Sheets("Adultos").Range("N:N,Q:AE,AG:AG,AI:AR").EntireColumn.Hidden = True
...
ThisWorkbook.Sheets("Embarazos y Partos").Range("N:N,Q:AK,AM:AM,AO:AX").EntireColumn.Hidden = True
...
ThisWorkbook.Sheets("Niños en internación").Range("N:N,Q:V,X:X,Z:AI").EntireColumn.Hidden = True
ThisWorkbook.Sheets("Niños en internación").Protect Password:=contraseña, _
DrawingObjects:=False, Contents:=True, Scenarios:=False, _
AllowFormattingCells:=True, AllowFormattingColumns:=False, AllowFormattingRows:=True, AllowSorting:=True, AllowFiltering:=True, _
AllowUsingPivotTables:=True, UserInterfaceOnly:=True
    
ThisWorkbook.Sheets("Embarazos de alto riesgo").Range("N:N,Q:AA,AC:AC,AE:AN").EntireColumn.Hidden = True
