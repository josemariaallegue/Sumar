VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} userForm_tz9 
   Caption         =   "Formulario de relevamiento - Trazadora 9"
   ClientHeight    =   5865
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   19290
   OleObjectBlob   =   "userForm_tz9.frx":0000
   StartUpPosition =   1  'Centrar en propietario
End
Attribute VB_Name = "userForm_tz9"
...
If (userForm_tz9_verificacion_blancos = 1) Then
...
If (auxiliarInexistenteTz9 = 1) Then
...
End If
    ...
    auxiliarInexistenteTz9 = 0

End If


Call userForm_tz9_guardar_datos(filaDobleClickTz9)

MsgBox ("Se han guardado con exito")


If (userForm_tz9.dato_validacion.Text = "Labrar acta" Or userForm_tz9.dato_validacion.Text = "Labrar acta e indicar fuente de información en observaciones") Then

    Cells(filaDobleClickTz9, columnaDobleClickTz9).Value = "Labrar acta"

ElseIf (userForm_tz9_verificacion_blancos <> 1) Then

    Cells(filaDobleClickTz9, columnaDobleClickTz9).Value = "Completo"

Else

    Cells(filaDobleClickTz9, columnaDobleClickTz9).Value = "Incompleto"
...
userForm_tz9.dato_observaciones.MultiLine = True
...
Private Sub dato_vacuna_bacteriana_pregunta_Change()

'con este if se evita que se ingresen datos que no estan permitidos
If (dato_vacuna_bacteriana_pregunta.Text <> "Si" And dato_vacuna_bacteriana_pregunta.Text <> "si" And dato_vacuna_bacteriana_pregunta.Text <> "No" And dato_vacuna_bacteriana_pregunta.Text <> "no" And _
dato_vacuna_bacteriana_pregunta.Text <> "Dato no obligatorio") Then

dato_vacuna_bacteriana_pregunta.Text = ""

End If


'bloquea y desbloquea el campos de diagnostico encontrado en terreno dependiendo del valor ingresado
If (dato_vacuna_bacteriana_pregunta.Text = "Si" Or dato_vacuna_bacteriana_pregunta.Text = "si") Then
...
ElseIf (dato_vacuna_bacteriana_pregunta.Text = "No" Or dato_vacuna_bacteriana_pregunta.Text = "no") Then
...
Private Sub dato_vacuna_viral_pregunta_Change()

'con este if se evita que se ingresen datos que no estan permitidos
If (dato_vacuna_viral_pregunta.Text <> "Si" And dato_vacuna_viral_pregunta.Text <> "si" And dato_vacuna_viral_pregunta.Text <> "No" And dato_vacuna_viral_pregunta.Text <> "no" And _
dato_vacuna_viral_pregunta.Text <> "Dato no obligatorio") Then

dato_vacuna_viral_pregunta.Text = ""

End If


'bloquea y desbloquea el campos de diagnostico encontrado en terreno dependiendo del valor ingresado
If (dato_vacuna_viral_pregunta.Text = "Si" Or dato_vacuna_viral_pregunta.Text = "si") Then
...
ElseIf (dato_vacuna_viral_pregunta.Text = "No" Or dato_vacuna_viral_pregunta.Text = "no") Then
...
dato_fuente.Text = "No consta fuente de información" Or dato_fuente.Text = "Prestación inexistente") Then
    ...
    If dato_fuente.Text <> "No consta fuente de información" And dato_fuente.Text <> "Prestación inexistente" And dato_fuente.Text <> "Caso duplicado" Then
        ...
        Call userForm_tz9_permitir_campos_requeridos
        auxiliarInexistenteTz9 = 0
...
'consulta sobre la fecha de vacuna triple o doble viral encontrada en terreno
With dato_vacuna_viral_pregunta
.AddItem "Si"
.AddItem "No"
End With

'consulta sobre la fecha de vacuna antipoliomielitica encontrada en terreno
